...
.btn-write { padding: 8px 20px; background: #5c6bc0; color: white; border: none; border-radius: 6px; font-size: 14px; cursor: pointer; }
.btn-write:hover { background: #3949ab; }
...
.comment-count { color: #5c6bc0; font-size: 13px; margin-left: 4px; }
...
.page-num.active { background: #5c6bc0; color: white; border-color: #5c6bc0; font-weight: bold; }
</style>
