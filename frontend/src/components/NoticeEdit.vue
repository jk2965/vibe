  ...
  <div class="write-container">
    ...
    <div class="write-card">
      ...
      <div class="btn-row">
        ...
        <button @click="$router.push(`/notice/${postId}`)" class="btn-cancel">취소</button>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    async submit() {
      ...
      try {
        await axios.put(`http://localhost:8090/api/notice/${this.postId}`, {
...
.btn-submit { padding: 11px 36px; background: #00796b; color: white; border: none; border-radius: 6px; font-size: 15px; cursor: pointer; }
